...
description: "This is the Website Terms of Use for BBC"
---

The Billionaire Blockchain Club (“BBC”, “we,” “us,” or “our”) is a wholly owned subsidary of WEN Token, LLC. We welcome you. We invite you to access and use our website, located at https://bbclub.vip/ (the “Website”).    
...
If you would like to receive or purchase BBC tokens, please see our BBC Token Issuance Terms and Conditions, which are available here - https://docs.bbclub.vip/issuance-terms.  Your receipt or purchase of BBC tokens is governed by the BBC Issuance Terms and Conditions. 
...
BBC’s community, like any community, functions best when its people follow a few simple rules.  By accessing and/or using the Website, you hereby agree to comply with these community rules and that:  
	...
	- You will not interfere with or attempt to interrupt the proper operation of the Website or BBC through the use of any virus, device, information collection or transmission mechanism, software or routine, or access or attempt to gain access to any data, files, or passwords related to the Website or BBC tokens through hacking, password or data mining, or any other means.
...
The trademarks, service marks, and logos of BBC (“BBC Trademarks”) used and displayed on the Website are registered and unregistered trademarks or service marks of BBC.  Other company, product, and service names located on the Website may be trademarks or service marks owned by others (the “Third-Party Trademarks,” and, collectively with the BBC Trademarks, the “Trademarks”).  Nothing on the Website should be construed as granting, by implication, estoppel, or otherwise, any license or right to use the Trademarks, without our prior written permission specific for each such use.  Use of the Trademarks as part of a link to or from any site is prohibited unless establishment of such a link is approved in advance by us in writing.  All goodwill generated from the use of the BBC Trademarks inures to our benefit. 
...
The Website may contain links to third-party websites (“External Sites”).  These links are provided solely as a convenience to you and not as an endorsement by us of the content on such External Sites.  The content of such External Sites is developed and provided by others.  You should contact the site administrator or webmaster for those External Sites if you have any concerns regarding such links or any content located on such External Sites.  Other than with respect to any content posted by BBC on such External Sites, we are not responsible for the content of any linked External Sites and do not make any representations regarding the content or accuracy of materials on such External Sites.  You should take precautions when downloading files from all websites to protect your computer from viruses and other destructive programs.  If you decide to access linked External Sites, you do so at your own risk.
